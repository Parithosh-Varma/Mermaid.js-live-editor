import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-3PRMMU7V.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-APLAPAXT.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-VKFMJZFB-JN5CTQ7M.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-5IMT3BWC-LVF65EOE.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-T4LZIETB.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-CVNBK5PI.js.map
